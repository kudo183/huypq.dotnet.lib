...
namespace huypq.Crypto
{
    ...
    public static class Base64UrlEncoder
    {
        ...
        public static byte[] DecodeBytes(string str)
        {
            ...
            return Convert.FromBase64String(ToBase64(str));
        }
        ...
        public static string ToBase64(string base64URL)
        {
            ...
            base64URL = base64URL.Replace(base64UrlCharacter62, base64Character62);

            // 63rd char of encoding
            base64URL = base64URL.Replace(_base64UrlCharacter63, base64Character63);
            ...
            switch (base64URL.Length % 4)
            {
                ...
                case 2:
                    // Two pad chars
                    base64URL += doubleBase64PadCharacter;
                    break;
                case 3:
                    // One pad char
                    base64URL += base64PadCharacter;
                    break;
                default:
                    throw new ArgumentException("base64URL");
            }
